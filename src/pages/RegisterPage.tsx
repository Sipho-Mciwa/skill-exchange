    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full lg:w-1/2 bg-[#F4FAF4] flex items-center justify-center px-6 py-12">
        <div className="max-w-sm w-full mx-auto space-y-6">
          ...
          {/* Heading */}
          <div>
            <h1 className="text-2xl font-bold text-[#1A2E1A]">Join your neighbourhood</h1>
            <p className="text-sm text-[#6B8F6B] mt-1">Create your free account</p>
          </div>
          ...
          <p className="text-sm text-[#6B8F6B] text-center">
            ...
            <Link to="/login" className="text-[#2C5F2D] font-medium hover:underline">
              Sign in
            </Link>
          </p>
        </div>
